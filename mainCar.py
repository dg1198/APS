...
mydb = mysql.connector.connect(host = "localhost", user = "car1", passwd = "devyani", database = "car1", autocommit=True)
mycursor = mydb.cursor()

mydb = mysql.connector.connect(host="localhost", user="car1", passwd="devyani", database="car1", autocommit=True)
mycursor = mydb.cursor()

# Check if 'slot' table exists before dropping
mycursor.execute("SHOW TABLES LIKE 'slot'")
...
class Ui(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        uic.loadUi(r"C:\Users\devya\OneDrive\Documents\AutomaticParkingSystem\APS\new\new\front.ui", self)
